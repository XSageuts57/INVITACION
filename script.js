...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 2:
            ...
            document.getElementById('question').style.fontSize = '23px';
            // Hacer que el botón "Sí" crezca
        ...
        case 6:
            ...
            break;
        case 7:
            document.getElementById('noBtn').innerHTML = 'Elige bien, te lo pido por favor';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            ...
            break;
        case 8:
            document.getElementById('noBtn').innerHTML = 'Ya no hay más gifs, ¿en serio no?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            ...
            break;
        case 9:
            // Última opción del botón "No"
            document.getElementById('noBtn').innerHTML = 'De verdad espero tu respuesta';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer1').style.display = 'none';
            document.getElementById('sadGifContainer2').style.display = 'none';
            document.getElementById('sadGifContainer').style.display = 'none';
            ...
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('messageContainer').style.display = 'block';
            document.getElementById('messageContainer').innerHTML = '¡Qué tristeza! <br> Estaré esperando otra oportunidad. <br> :((((';
            break;
    }
});
